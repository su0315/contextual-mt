...
nmt_models_dir=C:/Users/hsmr0/IM/main/NMT_models #CZ: this is where I downloaded the small model
...
for lang in $src_lang $tgt_lang; do
    python $REPO/scripts/spm_train.py \
        ${data_dir}/train.${lang} \
        --model-prefix ${data_dir}/prep/spm.${lang}.nopretok.model --vocab-file ${nmt_models_dir}/jparacrawl/${src_lang}-${tgt_lang}/small_${src_lang}-${tgt_lang}/dict.${lang}.txt \
